...
namespace CMF
{
	...
	public class CameraController : MonoBehaviour {
		...
		public float inputSmoothingAmount = 1f;
		...
		protected PlayerMouseInput cameraInput;

		//Setup references.
		void Awake () {
			tr = transform;
			cam = GetComponent<Camera>();
			cameraInput = GetComponent<PlayerMouseInput>();
		...
		{
			cameraInput.OnLook += OnLookEvent;
		}
		...
		private void OnLookEvent(Vector2 lookVector)
		{
