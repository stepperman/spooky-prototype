...
namespace FMODUnity
{
    ...
    public class StudioEventEmitterEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var occlusionParameter = serializedObject.FindProperty("OcclusionParameter");
            ...
            {
                {
                    ...
                    EditorGUILayout.PropertyField(occlusionEnabled, new GUIContent("Occlusion Enabled"));
                    EditorGUILayout.PropertyField(occlusionParameter, new GUIContent("Occlusion Parameter"));
